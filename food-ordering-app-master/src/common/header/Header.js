...
class Header extends Component {
    ...
    constructor() {
        ...
        this.state = {
            ...
            loginContactNoRequiredMsg: 'необходимо',
            loginContactNo: '',
            loginPasswordRequired: 'display-none',
            loginPasswordRequiredMsg: 'необходимо',
            loginPassword: '',
            firstNameRequired: 'display-none',
            firstName: '',
            lastName: '',
            emailRequired: 'display-none',
            emailRequiredMsg: 'необходимо',
            email: '',
            signupPasswordRequired: 'display-none',
            signupPasswordRequiredMsg: 'необходимо',
            signupPassword: '',
            signupContactNoRequired: 'display-none',
            signupContactNoRequiredMsg: 'необходимо',
            signupContactNo: '',
            signupSuccess: false,
    ...
    loginClickHandler = () => {
        ...
        if (contactReq === false && (validateContact.test(this.state.loginContactNo) === false || this.state.loginContactNo.length !== 10)) {
            this.setState({
                loginContactNoRequired: 'display-block',
                loginContactNoRequiredMsg: 'Неверный номер',
            });
            return;
        }
    ...
    singupClickHandler = () => {
        ...
        if (emailReq === false && validateEmail.test(this.state.email) === false) {
            this.setState({
                emailRequired: 'display-block',
                emailRequiredMsg: 'Неправильный Email'
            });
            return;
        }
        ...
        if (passwordReq === false && validatePassword.test(this.state.signupPassword) === false) {
            this.setState({
                signupPasswordRequired: 'display-block',
                signupPasswordRequiredMsg: 'Пароль должен включать в себя :большую букву,маленькую букву,цифру,специальный символ'
            });
            return;
        }
        ...
        if (contactNoReq === false && (validateContact.test(this.state.signupContactNo) === false || this.state.signupContactNo.length !== 10)) {
            this.setState({
                signupContactNoRequired: 'display-block',
                signupContactNoRequiredMsg: 'Номер должен содержать только 10 цифр'
            });
            return;
        }
        ...
        return (
            <div>
                    ...
                    {!this.state.loggedIn ?
                        ...
                        <div className={this.props.showSearchBox ? 'app-login-1' : 'app-login-2'}>
                            ...
                            >
                                ...
                                <MenuItem onClick={this.logoutOnClickHandler}>Выйти</MenuItem>
                            </Menu>
                        </div>
                    }
                ...
                >
                    ...
                    {this.state.value === 0 &&
                        <TabContainer>
                            ...
                            <FormControl required>
                                <InputLabel htmlFor='loginContactNo'>Номер</InputLabel>
                                <Input
                                    id='loginContactNo'
                                    type='text'
                            ...
                            <form>
                                <FormControl required>
                                    <InputLabel htmlFor='loginPassword'>Пароль</InputLabel>
                                    <Input
                                        id='loginPassword'
                                        type='password'
                            ...
                            <Button id='modal-login-btn' variant='contained' color='primary' onClick={this.loginClickHandler}>Логин</Button>
                        </TabContainer>
                    }
                    ...
                    {this.state.value === 1 &&
                        <TabContainer>
                            ...
                            <form>
                                <FormControl required>
                                    <InputLabel htmlFor='signupPassword'>Пароль</InputLabel>
                                    <Input
                                        id='signupPassword'
                                        type='password'
                            ...
                            {/* signup contact no */}
                            <FormControl required>
                                <InputLabel htmlFor='signupContactNo'>Номер</InputLabel>
                                <Input
                                    id='signupContactNo'
                                    type='text'
                            ...
                            <Button id='modal-signup-btn' variant='contained' color='primary' onClick={this.singupClickHandler}>ВХОД</Button>
                        </TabContainer>
                    }
                </Modal>
                ...
                <Snackbar
                    ...
                    message={<span id='message-id'>Вы зарегистрировались!</span>}
                />
