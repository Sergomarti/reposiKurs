...
class Checkout extends Component {
    ...
    saveAddressOnClickHandler = () => {
        ...
        if (pincodeReq === false && validatePincode.test(this.state.pincode) === false) {
            this.setState({
                pincodeRequired: 'display-block',
                pincodeRequiredMsg: 'Пинкод состоит из 6 чисел'
            });
            return;
        }
        ...
        xhrNewAddress.addEventListener('readystatechange', function () {
            if (this.readyState === 4) {
                ...
                xhrCustomerAddress.setRequestHeader('authorization', 'Bearer ' + sessionStorage.getItem('access-token'));
                xhrCustomerAddress.send(dataCustomerAddress);
                window.alert('Новый Адрерс добавлен!');
            }
        });
            ...
            if (this.readyState === 4) {
                ...
                if (responseText.status === 'ORDER SUCCESSFULLY PLACED') {
                    that.setState({
                        ...
                        placeOrderMsg: `Заказ успешно оформлен! Ваш номер заказа - ${responseText.id}.`
                    });
                } else {
                    that.setState({
                        openPlaceOrderMsg: true,
                        orderId: '',
                        placeOrderMsg: 'Не получилось оформить ваш заказ! Попробуйте снова!'
                    });
                }
            }
        })
                                                ...
                                                <div className={classes.tabRoot}>
                                                    <AppBar position='static'>
                                                        <Tabs value={tabValue} onChange={this.tabChangeHandler}>
                                                            <Tab label='СУЩЕСТВУЮЩИЙ АДРЕС' />
                                                            <Tab label='НОВЫЙ АДРЕС' />
                                                        </Tabs>
                                                    </AppBar>
                                                        ...
                                                        <TabContainer className={classes.existingAddressTabContainer}>
                                                            {this.state.customerExistingAddresses === null ?
                                                                <Typography variant='h6' color='textSecondary'>
                                                                    Здесь нет адресов! Вы можете добавить адресс .
                                                                </Typography>
                                                                :
                                                                <GridList
                                                    ...
                                                    {tabValue === 1 &&
                                                        <TabContainer>
                                                            ...
                                                            <FormControl required>
                                                                <InputLabel htmlFor='flatBuildingNo'>Квартира</InputLabel>
                                                                <Input
                                                                    id='flatBuildingNo'
                                                                    type='text'
                                                            ...
                                                            <FormControl required>
                                                                <InputLabel htmlFor='locality'>Расположение</InputLabel>
                                                                <Input
                                                                    id='locality'
                                                                    type='text'
                                                                    locality={this.state.locality}
                                                            ...
                                                            <FormControl required className={classes.newAddressFormControl}>
                                                                <InputLabel htmlFor='newAddressstate'></InputLabel>
                                                                <Select
                                                                    id='newAddressstate'
                                                            ...
                                                            {/* new address - pincode */}
                                                            <FormControl required>
                                                                <InputLabel htmlFor='pincode'>Пинкод</InputLabel>
                                                                <Input
                                                                    id='pincode'
                                                                    type='text'
                                                                    pincode={this.state.pincode}
                                            ...
                                            {index === 1 ?
                                                <div className={classes.radioRoot}>
                                                    <FormControl component='fieldset' className={classes.radioFormControl}>
                                                        <FormLabel component='legend'>Выберите вид оплаты</FormLabel>
                                                        <RadioGroup
                            ...
                            <CardContent>
                                ...
                                {this.state.customerCart.cartItems.map(item => (
                                    <div key={'item' + item.id + item.category_name} className='flex width-100 pd-1-per'>
                                        ...
                                        <div className='width-4 checkout-grey-color'></div>
