...
public class CouponEntity implements Serializable {
    ...
    public CouponEntity(Integer id, @NotNull @Size(max = 200) String uuid, @NotNull @Size(max = 255) String couponName, @NotNull Integer percent) {
        this.id = id;
        this.uuid = uuid;
    ...
    public CouponEntity(Integer id) {
        this.id = id;
    }
