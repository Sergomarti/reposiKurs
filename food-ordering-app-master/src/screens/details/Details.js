    ...
    getEachDish = (item_list, category_name) => {
        return item_list.map((item, index) => {
            ...
            return <div className="flex pd-1-per" key={index}>
                ...
                <div className="flex-10"> {item.price}.00</div>
    ...
    getCheckoutDishList = (checkoutArr) => {
        return checkoutArr.map((item, index) => {
            return <div className="flex width-100 pd-1-per" key={index}>
                ...
                <div className="width-2-5 checkout-grey-color"></div>
                                    ...
                                    <Grid container spacing={24}>
                                        <Grid item xs={6} sm={6}>
                                            <div className="container_item3">
                                                ...
                                                <p className="text_format">Средняя оценка<br /><span className="bold">{number_customers_rated}</span> посетителей</p>
                                            </div>
                                        </Grid>
                                        <Grid item xs={6} sm={6}>
                                            <div className="container_item3">
                                                 {average_price}
                                                <p className="text_format">Средняя чек на<br />двух человек</p>
                                            </div>
                                        </Grid>
                                    </Grid>
                                </Grid>
                            ...
                            <Card>
                                <CardContent>
                                    <Typography variant="h5" color="default" gutterBottom>
                                        ...
                                        <span className="mycart">Корзина</span>
                                    </Typography>

                                    {this.getCheckoutDishList(this.state.checkoutArr)}
                                    <div className="bold pd-1-per">Сумма <span className="right mr-8"> {this.state.totalPrice}.00</span></div>
